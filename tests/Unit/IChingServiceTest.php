...
describe('iChingService coin casting', function (): void {
    ...
    it('applies changing lines correctly', function () use (&$service) {
        ...
        expect($secondaryBinary)->toBe('101100');

        expect($service->applyChangingLines('111111', [0]))->toBe('011111');
        expect($service->applyChangingLines('000000', [5]))->toBe('000001');
        expect($service->applyChangingLines('101010', [1, 3, 5]))->toBe('111111');
    });
