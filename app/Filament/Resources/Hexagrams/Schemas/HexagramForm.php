...
class HexagramForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                self::getStaticInformationSection(),
                self::getTranslationSection(),
            ]);

    }

    private static function getStaticInformationSection(): Section
    {
    ...
    private static function getTranslationSection(): Section
    {
        return Section::make(__('Translation & Interpretation'))
            ...
            ->schema([
                self::getNamesSection(),
                self::getJudgmentSection(),
            ])
            ->columns(1)
            ->columnSpanFull();
    }

    private static function getNamesSection(): Section
    {
        return Section::make(__('Names'))
    ...
    private static function getJudgmentSection(): Section
    {
        return Section::make(__('Judgment'))
            ->schema([
